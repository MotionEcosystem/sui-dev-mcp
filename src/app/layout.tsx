...
export const metadata: Metadata = {
  ...
  description: "AI-powered development tools for the Sui blockchain ecosystem by Motion Labs. Get intelligent code assistance, documentation search, debugging help, and smart contract analysis directly in your IDE.",
  keywords: [
    "Sui",
    "blockchain",
    "MCP",
  ...
  openGraph: {
    ...
    description: "Transform your Sui development experience with AI-powered tools by Motion Labs. Intelligent code assistance, documentation search, and debugging help.",
